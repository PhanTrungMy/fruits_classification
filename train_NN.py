...
label_data = to_categorical(label_data, 10)
...
models = Sequential()
models.add(Conv2D(filters=64, kernel_size=(3,3), input_shape=(10,10,3),activation='relu'))
...
history = models.fit(x_train, y_train, validation_split= 0.1, epochs=50, batch_size=16)
test_loss, test_accuracy = models.evaluate(x_test, y_test)
print(f'Test Accuracy: {test_accuracy * 100:.2f}%')
save_model = models.save("model_new.h5")
