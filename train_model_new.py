...
img_array = []
label_data = np.load("label_data_new_50.npy")
print(label_data.shape)
label_name = np.load("label_new_50.npy")
print(label_name.shape)
data = np.load("data_new_50.npy")
print(data.shape)
...
history = models.fit(x_train, y_train, validation_split= 0.1, epochs=30, batch_size=16)
